	...
	<div class="col-md-6 col-lg-4 offset-lg-4 offset-md-3 mt-5">
		<div class="bg-light p-5 border shadow">
			...
			<form method="post" action="/login">
				...
				<div class="mb-4">
					<input value="${username}" required name="username" type="text"
						class="form-control" placeholder="Username">
				</div>
				<div class="mb-4">
					<input value="${password}" required name="password" type="password"
						class="form-control" placeholder="Password">
				</div>
				<div class="mb-4 form-check w-100" style="display: flex">
					<label style="display: inline-block;" class="form-check-label">
